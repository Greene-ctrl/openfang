...
class SearchEngine(Tool):
    ...
    async def execute(self, query: str, category: str = "general", num_results: int = 5, timeout: int = 15) -> Response:
        """
        ...
        try:
            response = requests.get(
                ...
                params=params,
                timeout=timeout  # A generous but necessary timeout for a public service
            )
